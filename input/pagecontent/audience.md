...
<!-- TODO: Expand each row with a brief narrative paragraph describing what
     each audience needs from this IG and any prerequisites they should have.
-->
...
<!-- TODO: Insert a paragraph for developers. Include:
       ...
       - Recommended tooling (SUSHI, IG Publisher, HAPI FHIR validator)
       - How to submit questions or issues (HL7 Jira, GitHub)
-->
...
<!-- TODO: Insert a brief, plain-language paragraph explaining what this
     ...
     tests, safer transfusions). Point to patient-facing resources. -->
