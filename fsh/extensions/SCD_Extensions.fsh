//New Extension for use of BDP in Procedure
Extension: BiologicallyDerivedProductUsed
Id: biologically-derived-product-used
Title: "Biologically Derived Product Used"
Description: "A reference to the Biologically Derived Product (BDP) resource that was used in the performance of this procedure (e.g.: blood product used in a transfusion)."
Context: Procedure
...
//New extension for referencinga lab result as evidence dertail for a condition/diagnosis
Extension: ResultObservationEvidence
Id: result-observation-evidence
Title: "Result Observation Evidence of Condition"
Description: "A reference to the laboratory ResultObservation resource containing evidence that supports this condition/diagnosis."
Context: SCDConditionEncounterDiagnosis, SCDConditionProblemsAndHealthConcerns

* value[x] only Reference(SCDObservationLaboratoryResult)
* value[x] 0..1
* valueReference MS


/* This block commented out as it was AI generated based on proposed value sets
