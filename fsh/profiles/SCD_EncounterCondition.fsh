...
* ^status = #active
 //* extension contains ResultObservationEvidence named diagnosisEvidence 0.1 MS
* ^experimental = false
* ^date = "2025-01-01"
...
* recordedDate MS
* evidence MS
* evidence.detail MS Reference(Resource)
...
* ^status = #active
 // * extension contains ResultObservationEvidence named conditionEvidence 0..1 MS
* ^experimental = false
* ^date = "2025-01-01"
* ^publisher = "HL7 International / Patient Care"
* ^jurisdiction = urn:iso:std:iso:3166#US "United States of America"
